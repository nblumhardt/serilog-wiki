_Serilog 2.0 is currently a release candidate (RC). The final release-to-web version will ship in conjunction with the .NET Core RTW in mid-2016. These instructions are work-in-progress until that date._
